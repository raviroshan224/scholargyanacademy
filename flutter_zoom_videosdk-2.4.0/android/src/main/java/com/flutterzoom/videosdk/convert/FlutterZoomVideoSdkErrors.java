...
public class FlutterZoomVideoSdkErrors {
    ...
    private static final Map<Integer, String> errors =
            new HashMap<Integer, String>() {{
                ...
                put(ZoomVideoSDKErrors.Errors_Session_Reconncting, "ZoomVideoSDKError_Session_Reconnecting");
                put(ZoomVideoSDKErrors.Errors_Session_Disconnect, "ZoomVideoSDKError_Session_Disconnecting");
