...
class _ExamDetailPageState extends ConsumerState<ExamDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final description = detail?.description == null
        ? ''
        : AppMethods.parseHtmlToPlainText(htmlString: detail!.description!);
    ...
    return Scaffold(
      ...
      body: state.isLoading && detail == null
          ...
          : detail == null
          ? const _ErrorView(message: 'Exam details are unavailable.')
                ...
                children: [
                  AspectRatio(
                    ...
                    child: CachedNetworkImage(
                      imageUrl: detail.examImageUrl ?? AppAssets.dummyNetImg,
                      fit: BoxFit.cover,
                      placeholder: (context, url) =>
                          const Center(child: CircularProgressIndicator()),
                      errorWidget: (context, url, error) =>
                          Image.asset(AppAssets.errorImage, fit: BoxFit.cover),
                    ),
                  ),
                  Padding(
                        ...
                        if (detail.courseDetails.isNotEmpty) ...[
                          ...
                          Column(
                            children: detail.courseDetails
                                .map(
                                  (course) =>
                                      _CourseDetailSection(course: course),
                                )
                                .toList(),
                          ),
                        ],
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (onRetry != null) ...[
              AppSpacing.verticalSpaceMedium,
              ReusableButton(text: 'Retry', onPressed: onRetry!),
            ],
          ],
        ),
      ),
